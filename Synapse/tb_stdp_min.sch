...
linewidth_mult=4}
B 2 640 300 1440 700 {flags=graph
y1=-0.77
y2=0.68
ypos1=0
ypos2=2
...
C {vsource.sym} -100 -50 0 0 {name=V3 value=1.8 savecurrent=false}
C {vdd.sym} -100 -80 0 0 {name=l3 lab=VDD}
C {gnd.sym} -100 -20 0 0 {name=l4 lab=GND}
C {stdp_min.sym} 150 60 0 0 {name=xstdp1}
C {devices/vsource.sym} -110 130 0 1 {name=V1 value="PULSE(0 1.8 0 5n 5n 500n 1000n 20)"}
C {devices/vsource.sym} 410 140 0 0 {name=V2 value="PULSE(0 1.8 20u 5n 5n 500n 1000n 20)"}
C {devices/code_shown.sym} -280 230 0 0 {name=NGSPICE
only_toplevel=true
value="
